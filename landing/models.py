...
class Project(models.Model):
	...
	short_description = models.TextField(verbose_name='Card description', help_text='Short text shown on the project card.')
	description = models.TextField(blank=True, verbose_name='Full description', help_text='The main text shown after visitors open “More details”.')
	date_label = models.CharField(max_length=120, blank=True, verbose_name='Date', help_text='Free text supports date ranges and notes, for example: “11–12 September 2026 (festival runs 9–16 September)”.')
	goal = models.TextField(blank=True, help_text='Shown in the project facts on the full page.')
	budget = models.CharField(max_length=180, blank=True, help_text='For example: “fundraising target — €70,000”.')
	partners = models.TextField(blank=True, help_text='Separate names with commas.')
	participants = models.TextField(blank=True, help_text='Separate names with commas.')
	outcome = models.TextField(blank=True, help_text='Optional result, award, or next milestone.')
	website_text = models.TextField(blank=True, verbose_name='Website text', help_text='A highlighted editorial note displayed on the full project page.')
